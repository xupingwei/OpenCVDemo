...
/**
 * Created by xupingwei on 2017/6/16.
 */
...
public class CameraCalibrator {
    ...
    private double computeReprojectionErrors(ArrayList<Mat> objectPoints, ArrayList<Mat> rvecs, ArrayList<Mat> tvecs, Mat perViewErrors) {
    ...
    private void calcBoardCornerPositions(Mat mat) {
        ...
        mCorners.create(mCornersSize, 1, CvType.CV_32FC3);
        mCorners.put(0, 0, positions);
    }
